...
<html lang="en-US">
<head>
<title>How To Create an Image Zoom</title>
<meta charset="utf-8">
...
<h2>Python</h2>
<a target="_top" href="howto_python_remove_duplicates.asp">Remove List Duplicates</a>
<a target="_top" href="howto_python_reverse_string.asp">Reverse a String</a>
...
<h1>How TO - Image Zoom</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_portfolio_filter.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_image_magnifier_glass.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create an image zoom.</p>
<hr>
<h2>Image Zoom</h2>
<p>Mouse over the image:</p>

<div class="img-zoom-container">
  <img id="zoomimage" src="img_girl.jpg" width="300" height="240">
<p>Zoom Preview:</p>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_js_image_zoom" class="w3-btn">Try it Yourself &raquo;</a></p>

<hr>

<h2>Create an Image Zoom</h2>
<h5>Step 1) Add HTML:</h5>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;img-zoom-container&quot;&gt;<br>&nbsp; &lt;img 
  id=&quot;myimage&quot; src=&quot;img_girl.jpg&quot; width=&quot;300&quot; height=&quot;240&quot; 
  alt=&quot;Girl&quot;&gt;<br>&nbsp; &lt;div 
  id=&quot;myresult&quot; class=&quot;img-zoom-result&quot;&gt;&lt;/div&gt;<br>&lt;/div&gt;<br></div>
</div>
...
<div class="w3-code notranslate cssHigh">
  * {box-sizing: border-box;}<br><br>.img-zoom-container {<br>&nbsp; 
  position: relative;<br>}<br><br>.img-zoom-lens {<br>&nbsp; position: absolute;<br>&nbsp; border: 1px solid 
  #d4d4d4;<br>&nbsp; /*set the size of the lens:*/<br>&nbsp; width: 40px;<br>&nbsp; 
  height: 40px;<br>}<br><br>.img-zoom-result 
  {<br>&nbsp; border: 1px solid #d4d4d4;<br>&nbsp; /*set the size of the result 
  div:*/<br>&nbsp; width: 300px;<br>&nbsp; height: 300px;<br>}</div>
</div>
<hr>
...
<div class="w3-code notranslate jsHigh">
  function imageZoom(imgID, resultID) {<br>&nbsp; var img, lens, result, cx, cy;<br>&nbsp; 
  img = document.getElementById(imgID);<br>&nbsp; result = 
  document.getElementById(resultID);<br>&nbsp; /*create lens:*/<br>&nbsp; lens = 
  document.createElement(&quot;DIV&quot;);<br>&nbsp; lens.setAttribute(&quot;class&quot;, &quot;img-zoom-lens&quot;);<br>&nbsp; 
  /*insert lens:*/<br>&nbsp; img.parentElement.insertBefore(lens, img);<br>&nbsp; 
  /*calculate the ratio between result DIV and lens:*/<br>&nbsp; cx = 
  result.offsetWidth / lens.offsetWidth;<br>&nbsp; cy = result.offsetHeight / 
  lens.offsetHeight;<br>&nbsp; /*set background properties for the result DIV*/<br>&nbsp; 
  result.style.backgroundImage = &quot;url('&quot; + img.src + &quot;')&quot;;<br>&nbsp; 
  result.style.backgroundSize = (img.width * cx) + &quot;px &quot; + (img.height * cy) + &quot;px&quot;;<br>&nbsp; 
  /*execute a function when someone moves the cursor over the image, or the 
  lens:*/<br>&nbsp; lens.addEventListener(&quot;mousemove&quot;, moveLens);<br>&nbsp; 
  img.addEventListener(&quot;mousemove&quot;, moveLens);<br>&nbsp; 
  /*and also for touch screens:*/<br>&nbsp; lens.addEventListener(&quot;touchmove&quot;, moveLens);<br>&nbsp; 
  img.addEventListener(&quot;touchmove&quot;, moveLens);<br>&nbsp; function moveLens(e) {<br>&nbsp;&nbsp;&nbsp; 
  var pos, x, y;<br>&nbsp;&nbsp;&nbsp; /*prevent any other actions that may 
  occur when moving over the image*/<br>&nbsp;&nbsp;&nbsp; e.preventDefault();<br>&nbsp;&nbsp;&nbsp; /*get the cursor's x and y positions:*/<br>&nbsp;&nbsp;&nbsp; 
  pos = getCursorPos(e);<br>&nbsp;&nbsp;&nbsp; /*calculate the position of the 
  lens:*/<br>&nbsp;&nbsp;&nbsp; x = pos.x - (lens.offsetWidth / 2);<br>&nbsp;&nbsp;&nbsp; 
  y = pos.y - (lens.offsetHeight / 2);<br>&nbsp;&nbsp;&nbsp; /*prevent the lens 
  from being positioned outside the image:*/<br>&nbsp;&nbsp;&nbsp; if (x &gt; 
  img.width - lens.offsetWidth) {x = img.width - lens.offsetWidth;}<br>&nbsp;&nbsp;&nbsp; 
  if (x &lt; 0) {x = 0;}<br>&nbsp;&nbsp;&nbsp; if (y &gt; img.height - 
  lens.offsetHeight) {y = img.height - lens.offsetHeight;}<br>&nbsp;&nbsp;&nbsp; 
  if (y &lt; 0) {y = 0;}<br>&nbsp;&nbsp;&nbsp; /*set the position of the lens:*/<br>&nbsp;&nbsp;&nbsp; 
  lens.style.left = x + &quot;px&quot;;<br>&nbsp;&nbsp;&nbsp; lens.style.top = y + &quot;px&quot;;<br>&nbsp;&nbsp;&nbsp; 
  /*display what the lens &quot;sees&quot;:*/<br>&nbsp;&nbsp;&nbsp; 
  result.style.backgroundPosition = &quot;-&quot; + (x * cx) + &quot;px -&quot; + (y * cy) + &quot;px&quot;;<br>&nbsp; 
  }<br>&nbsp; function getCursorPos(e) {<br>&nbsp;&nbsp;&nbsp; var a, x = 0, y = 
  0;<br>&nbsp;&nbsp;&nbsp; e = e || window.event;<br>&nbsp;&nbsp;&nbsp; /*get 
  the x and y positions of the image:*/<br>&nbsp;&nbsp;&nbsp; a = 
  img.getBoundingClientRect();<br>&nbsp;&nbsp;&nbsp; /*calculate the cursor's x 
  and y coordinates, relative to the image:*/<br>&nbsp;&nbsp;&nbsp; x = e.pageX 
  - a.left;<br>&nbsp;&nbsp;&nbsp; y = e.pageY - a.top;<br>&nbsp;&nbsp;&nbsp; 
  /*consider any page scrolling:*/<br>&nbsp;&nbsp;&nbsp; x = x - 
  window.pageXOffset;<br>&nbsp;&nbsp;&nbsp; y = y - window.pageYOffset;<br>&nbsp;&nbsp;&nbsp; 
  return {x : x, y : y};<br>&nbsp; }<br>}</div>
</div>
<hr>

<h5>Step 4) Initiate the Zoom Effect:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;script&gt;<br>imageZoom("myimage&quot;, "myresult"); <br>&lt;/script&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_image_zoom" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
